...
(function() {
	...
	spr.balloon.red = new Sprite('/content/sprites/balloon_red.png',1,32,43);
	spr.balloon.blue = new Sprite('/content/sprites/balloon_blue.png',1,32,43);
	spr.balloon.green = new Sprite('/content/sprites/balloon_green.png',1,32,43);
	spr.background = new Sprite('/content/sprites/background.png',1,0,0);
